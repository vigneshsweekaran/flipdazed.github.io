...
\begin{tabular}{@{}p{3.17in}p{4in}}
	...
	% Edinburgh, EH9 1HA 
	 +44 (0) 7871 535 862
		& Available for interview for Nov. starts.\\
\end{tabular}

\section{\sc Background}

\begin{itemize}
	\item Quant. experience: Equity \& credit exotics
	\item M.Sc. in Theoretical Physics (graduating November)
	\item Monte Carlo for high dimensional problems
	\item Deep Machine Learning research: Stochastic applications (weather)
	\item Programming: \verb|Python|, \verb|Fortran|, \verb|VBA|
\end{itemize}
% I have quant. experience in pricing exotic derivatives and Python development. I am averaging 95\% in an M.Sc. at the prestigious Higgs Center for Theoretical Physics (Edinburgh University). I am also a part-time researcher in Deep Machine Learning. I am looking to continue to accelerate my learning by applying new techniques in quant finance. I am particularly good at quickly learning advanced ideas and implementing them with little assistance.
...
\\
	\vspace*{-.15in}
	% \begin{list1}
	% 	\item[] \emph{Summary:} High Energy Theory, Pure/Applied Math,
	% 	HPC \& Stochastic Modelling
	% \end{list1}
	\begin{list1}
